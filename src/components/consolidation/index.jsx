...
export default function Consolidation() {
  ...
  const [currentMemberAcademicStudy, setCurrentMemberAcademicStudy] =
    useState(null);
  ...
  return (
    <div className={styles.mainContainer}>
      <Box>
        <ModuleHeader
          title="Consolidación"
          description="Información detallada de miembros de la iglesia"
        />
        <button
          type="button"
          class="btn btn-dark"
          onClick={() => navigateToRoute('/members')}
        >
          Volver al listado
        </button>
        <Tabs
        ...
        >
          ...
          />
          <Tab
            label="ESTUDIOS / OTRAS FORMACIONES"
            disabled={areTabsDisabled}
            className={styles.tabs}
          />
          <Tab
            label="FORMACIÓN MINSTERIAL"
            disabled={areTabsDisabled}
            className={styles.tabs}
